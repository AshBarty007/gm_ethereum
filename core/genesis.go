...
func (g *Genesis) Commit(db ethdb.Database) (*types.Block, error) {
	...
	if config.Clique != nil && len(block.Extra()) < 32+gmsm.SignatureLength {
...
func DefaultGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Nonce:      66,
		ExtraData:  common.Hex2Bytes(""),
		GasLimit:   16777216,
...
func DeveloperGenesisBlock(period uint64, gasLimit uint64, faucet common.Address) *Genesis {
	...
	return &Genesis{
		Config:     &config,
		ExtraData:  append(append(make([]byte, 32), faucet[:]...), make([]byte, gmsm.SignatureLength)...),
		GasLimit:   gasLimit,
